...
static uint8_t tx1[4]={0x81, 0x73, 0x44, 0x55};
static uint8_t rx1[4]={0x00, 0x00, 0x00, 0x00};
struct work_data {
...
// msleep(2000);
  ...
  printk("1.2");
 printk("Value of TX is:%02x\n", tx1[0]);
 printk("Value of RX is:%02x\n", rx1[0]);
